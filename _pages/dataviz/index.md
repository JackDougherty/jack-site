...
Using [custom sidebar navigation menu](https://mmistakes.github.io/minimal-mistakes/docs/layouts/#custom-sidebar-navigation-menu), and author profile set to true (which places author sidebar on top of custom sidebar). Can also set author sidebar to false if preferred

Also using [custom auto TOC](https://mmistakes.github.io/minimal-mistakes/docs/layouts/#table-of-contents) for displaying schedule of classes: Wk1, Wk2, ...
